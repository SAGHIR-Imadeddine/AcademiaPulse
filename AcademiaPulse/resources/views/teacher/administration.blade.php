...
<div class="p-4 rounded-lg mt-14">
        ...
        @endif
             <div class="items-center  space-y-8 mx-4 mb-12">
                <div
                  class="max-w-7xl sm:mx-auto flex flex-row items-center bg-sky-800 p-4 md:p-3  font-medium rounded-3xl ">
                  <div class="flex flex-col md:flex-row justify-between items-center text-gray-300">
                    <div class="flex-initial inline-flex w-full md:w-8/12 items-center text-justify text-sm pr-4">
                      <span class="">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mr-2 text-slate-400" viewBox="0 0 20 20"
                          fill="currentColor">
                    ...
                    <div class="flex flex-row gap-x-2 md:gap-x-5 mt-4 md:mt-0">
                      ...
                      <a href="{{ route('certificate') }}"
                        class="uppercase px-2 md:px-1 lg:px-3 rounded-md py-3 text-center text-sm bg-slate-400 text-white font-bold font-mono">Télécharger ici</a>
                      @else
                ...
                <form action="{{ route('send-message') }}" method="POST" class="form bg-white p-6 my-10 relative">
                    ...
                    <h3 class="text-2xl text-slate-600 font-semibold">Contact Us</h3>
                    ...
                    <button type="submit"  class="w-full text-white  flex items-center justify-center  text-xl font-bold font-mono  bg-gray-400 hover:bg-gray-600 ease-in duration-200 rounded-lg  px-5 py-2.5 mt-4"> Envoyer </button>
                </form>
        </div>
    </div>
@endsection