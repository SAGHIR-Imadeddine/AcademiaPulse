...
<div class="p-4 rounded-lg mt-14">
            ...
            @if ($teacherClasses->count() > 0)
                @foreach ($teacherClasses as $teacherClasses)
                    <div class="bg-sky-400 rounded-lg shadow-xl pb-8">
                        <div class="w-full h-[200px]">
                            <img src="{{ asset('photos/classe.jpg') }}" class="w-full h-full rounded-tl-lg rounded-tr-lg">
                        </div>
                        <div class="flex flex-col items-center mt-4">
                            <p class="text-m text-slate-600 font-mono font-bold">Class Name:</p>
                            ...
                            <div class="flex mx-auto border-2 border-slate-500 rounded overflow-hidden mt-6">
                                <button class="py-1 px-4 bg-slate-500 text-white " onclick="openTab(event, 'student')">Students</button>
                                    ...
                                    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                                        <div class="w-full overflow-x-auto">
                                            <table class="w-full">
                                                <thead>
                                                    <tr
                                                        class="text-md font-bold tracking-wide font-mono text-center text-slate-600 bg-sky-200 uppercase border-b border-white">
