...
<div class="p-4 h-screen sm:ml-64 bg-slate-200">
    <div class="p-4 rounded-lg mt-14">
        <h1 class="text-center font-mono font-bold text-slate-600 text-2xl  mt-4 ">Student Absences</h1>

        <div class="w-full overflow-x-auto">
            @foreach($classes as $class)
            <h2 class="text-left font-mono font-bold text-blue mb-2 mt-8 text-xl"><span class="text-slate-600">Classe : </span>{{ $class->name }}</h2>
            @php
            ...
            <tbody class="bg-white">
                <table class="w-full">
                    <thead>
                        <tr class="text-md font-bold tracking-wide text-center text-slate-600 bg-sky-200 uppercase">
