...
<div class="p-4 rounded-lg mt-14">
            ...
            <div class="grid grid-cols-1 gap-2 lg:gap-8 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 mt-8">
                <div class=" bg-gray-200 p-2 lg:p-8 rounded-xl shadow-xl flex items-center justify-between  hover:-translate-y-0.5 lg:hover:-translate-y-1">
                    <div class="flex space-x-6 items-center">
                        <img src="{{ asset('photos/teacher.png') }}" class="w-auto h-8 lg:h-14 rounded-lg" />
                        <div>
                ...
                <div class="bg-gray-200 p-2 lg:p-8 rounded-xl shadow-xl flex items-center justify-between  hover:-translate-y-0.5 lg:hover:-translate-y-1">
                    <div class="flex space-x-6 items-center">
                        <img src="{{ asset('photos/students.png') }}" class="w-auto h-8 lg:h-14 rounded-lg" />
                ...
                <div class="bg-gray-200 p-2 lg:p-8 rounded-xl shadow-xl flex items-center justify-between hover:-translate-y-0.5 lg:hover:-translate-y-1 ">
                    <div class="flex space-x-6 items-center">
                        <img src="{{ asset('photos/parents.png') }}" class="w-auto h-8 lg:h-14 rounded-lg" />
                ...
                <div class="bg-gray-200 p-2 lg:p-8 rounded-xl shadow-xl flex items-center justify-between  hover:-translate-y-0.5 lg:hover:-translate-y-1  ">
                    <div class="flex space-x-6 items-center">
                        <img src="{{ asset('photos/salle-de-classe.png') }}" class="w-auto h-8 lg:h-14 rounded-lg" />
                ...
                <div class="bg-gray-200 p-2 lg:p-8 rounded-xl shadow-xl flex items-center justify-between hover:-translate-y-0.5 lg:hover:-translate-y-1 ">
                    <div class="flex space-x-6 items-center">
                        <img src="{{ asset('photos/bibliotheque.png') }}" class="w-auto h-8 lg:h-14 rounded-lg" />
                ...
                <div class="bg-gray-200 p-2 lg:p-8 rounded-xl shadow-xl flex items-center justify-between hover:-translate-y-0.5 lg:hover:-translate-y-1 ">
                    <div class="flex space-x-6 items-center">
                        <img src="{{ asset('photos/tester.png') }}" class="w-auto h-8 lg:h-14 rounded-lg" />
                ...
                <div class="mt-14 flex flex-col lg:flex-row rounded-lg border-2 border-white bg-slate-300 p-6 shadow-2xl">
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-slate-700 font-mono font-bold text-sm">Admin</span>
                            <h3 class="font-bold font-mono mt-px text-white ">{{Auth::user()->name}}</h3>
                            <div class="flex items-center gap-3 mt-2">
                                <span
                                    class="text-white font-mono italic  text-sm">{{Auth::user()->genre}}</span>
                                ...
                                <div class="w-32 flex-none rounded-t lg:rounded-t-none lg:rounded-l text-center shadow-lg ">
                                    <div class="block rounded-t overflow-hidden  text-center ">
                                        ...
                                        <div class="pb-2 border-l border-r border-b rounded-b-lg text-center border-white bg-white">
                                            <span class="font-bold font-mono text-l text-slate-500">
