                    ...
                    <div class="overflow-x-auto">
                        ...
                        <div class="flex justify-center items-center scroll">
                            <div
                                ...
                                <div class=" flex h-32 w-full justify-center rounded-xl bg-gradient-to-r from-slate-400 to-sky-200"></div>
                                @foreach ($children as $child)
                                    <div
                                        ...
                                        <div>
                                            <span class="text-slate-800 text-sm font-mono">Student :</span>
                                ...
                                <div
                                    class="bg-slate-300 mt-2 shadow-xl shadow-gray-100 w-full max-w-4xl flex flex-col sm:flex-row gap-3 sm:items-center justify-between px-5 py-4 rounded-md">
                                    <div>
                                        <span class="text-sky-800 text-l font-mono">Parent :</span>
