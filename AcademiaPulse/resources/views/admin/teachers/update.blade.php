...
@section('updateTeacher')
    <div class="p-4 sm:ml-64 bg-slate-200">
        <div class="p-4  rounded-lg  mt-14">
            ...
            <h2 class="flex items-center justify-center mb-4 mt-4 text-3xl font-bold font-mono text-slate-500">
                Update Teacher
            </h2>
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                        ...
                        <label class="block ">
                            <div class="shrink-0">
                                <img id='preview_img' class="h-20 w-20 object-cover rounded-full"
                                    src="{{ asset('users/' . $teacher->picture) }}" alt="Current profile photo" />
                            </div>
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                value="{{ $teacher->name }}" type="text" name="name" placeholder="Jane">
                        </div>
                        <div class="md:w-1/2 px-3">
                            ...
                            <input
                                ...
                                value="{{ $teacher->date }}" type="date" name="date" placeholder="Doe">
                        </div>
                    </div>
                    <div class="-mx-3 md:flex mb-6">
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                                value="{{ $teacher->email }}" type="email" name="email" placeholder="Jane">
                        </div>
                        <div class="md:w-1/2 px-3">
                            <label
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"
                                value="{{ $teacher->adress }}" type="text" name="adress" placeholder="Jane">
                        </div>
                        <div class="md:w-1/2 px-3">
                            <label
                            ...
                            <input
                                ...
                                value="{{ $teacher->phone }}" type="text" name="phone" placeholder="Doe">
                        </div>
                    </div>
                    <div class="-mx-3 md:flex mb-6">
                    ...
                    <button type="submit"
                        class="text-white  flex items-center justify-center  text-xl font-bold font-mono  bg-gray-400 hover:bg-gray-600 ease-in duration-200 rounded-lg  px-5 py-2.5  ">
