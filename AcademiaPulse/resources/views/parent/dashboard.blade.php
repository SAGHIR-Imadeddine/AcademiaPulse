...
<div class="p-4 rounded-lg mt-14">
                ...
                <div class="bg-gray-200 p-8 rounded-xl shadow-xl flex items-center justify-around   border-4 border-blue mt-14 ">
                ...
                <div class="mt-14 flex flex-col lg:flex-row rounded-lg border-2 border-white bg-slate-300 p-6 shadow-2xl">
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-slate-700 font-mono font-bold text-sm">Parent</span>
