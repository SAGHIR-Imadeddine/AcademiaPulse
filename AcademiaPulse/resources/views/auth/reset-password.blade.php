        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form action="{{ route('reset') }}" method="post" class="flex flex-col pt-3 md:pt-8">
                    ...
                    <button type="submit"
                        class="bg-slate-600 hover:bg-slate-400 text-white hover:text-slate-800 hover:border-2 hover:border-slate-500 ease-in-out duration-300 font-bold font-mono text-lg  p-2 mt-8 rounded">Reset</button>
                </form>
