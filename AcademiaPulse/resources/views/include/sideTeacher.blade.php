...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-[#03045e] dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('myClasse') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                    <img src="{{ asset('photos/salle-de-classe.png') }}" class="h-6 " alt="">

                    <span class="flex-1 ms-3 whitespace-nowrap">My classe</span>
                </a>
            </li>
            <li>
                <a href="{{ route('myTimeTable') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-[#fb5607] dark:hover:bg-gray-700 group">
                    <img src="{{ asset('photos/time.png') }}" class="h-6 " alt="">

                    <span class="flex-1 ms-3 whitespace-nowrap">My Time Table</span>
                </a>
            </li>
